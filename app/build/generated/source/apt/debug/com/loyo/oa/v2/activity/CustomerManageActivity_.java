...
public final class CustomerManageActivity_
    extends CustomerManageActivity
    implements HasViews, OnViewChangedListener
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(layout.activity_customer_manage);
    }
    ...
    public static CustomerManageActivity_.IntentBuilder_ intent(Context context) {
        return new CustomerManageActivity_.IntentBuilder_(context);
    }

    public static CustomerManageActivity_.IntentBuilder_ intent(android.app.Fragment fragment) {
        return new CustomerManageActivity_.IntentBuilder_(fragment);
    }

    public static CustomerManageActivity_.IntentBuilder_ intent(android.support.v4.app.Fragment supportFragment) {
        return new CustomerManageActivity_.IntentBuilder_(supportFragment);
    }
        ...
        if (layout_title_action!= null) {
            layout_title_action.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View view) {
                    CustomerManageActivity_.this.onClickChangeCategory();
                }
    ...
    public static class IntentBuilder_
        extends ActivityIntentBuilder<CustomerManageActivity_.IntentBuilder_>
    {
        ...
        public IntentBuilder_(Context context) {
            super(context, CustomerManageActivity_.class);
        }

        public IntentBuilder_(android.app.Fragment fragment) {
            super(fragment.getActivity(), CustomerManageActivity_.class);
            fragment_ = fragment;
        }
