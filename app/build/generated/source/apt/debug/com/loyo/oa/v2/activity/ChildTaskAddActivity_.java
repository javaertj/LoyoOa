...
public final class ChildTaskAddActivity_
    extends ChildTaskAddActivity
    implements HasViews, OnViewChangedListener
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(layout.activity_childtask_add_layout);
    }
    ...
    public static ChildTaskAddActivity_.IntentBuilder_ intent(Context context) {
        return new ChildTaskAddActivity_.IntentBuilder_(context);
    }

    public static ChildTaskAddActivity_.IntentBuilder_ intent(android.app.Fragment fragment) {
        return new ChildTaskAddActivity_.IntentBuilder_(fragment);
    }

    public static ChildTaskAddActivity_.IntentBuilder_ intent(android.support.v4.app.Fragment supportFragment) {
        return new ChildTaskAddActivity_.IntentBuilder_(supportFragment);
    }
    ...
    public void onViewChanged(HasViews hasViews) {
        ...
        if (layout_child_add_responser!= null) {
            layout_child_add_responser.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View view) {
                    ChildTaskAddActivity_.this.onClick(view);
                }

            }
            );
        }
        if (btn_child_add_complete!= null) {
            btn_child_add_complete.setOnClickListener(new OnClickListener() {
        ...
        if (btn_child_add_cancel_complete!= null) {
            btn_child_add_cancel_complete.setOnClickListener(new OnClickListener() {
    ...
    public static class IntentBuilder_
        extends ActivityIntentBuilder<ChildTaskAddActivity_.IntentBuilder_>
    {
        ...
        public IntentBuilder_(Context context) {
            super(context, ChildTaskAddActivity_.class);
        }

        public IntentBuilder_(android.app.Fragment fragment) {
            super(fragment.getActivity(), ChildTaskAddActivity_.class);
            fragment_ = fragment;
        }
