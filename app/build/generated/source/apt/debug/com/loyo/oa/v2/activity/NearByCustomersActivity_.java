...
public final class NearByCustomersActivity_
    extends NearByCustomersActivity
    implements HasViews, OnViewChangedListener
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(layout.activity_nearbycustomers);
    }
    ...
    public static NearByCustomersActivity_.IntentBuilder_ intent(Context context) {
        return new NearByCustomersActivity_.IntentBuilder_(context);
    }

    public static NearByCustomersActivity_.IntentBuilder_ intent(android.app.Fragment fragment) {
        return new NearByCustomersActivity_.IntentBuilder_(fragment);
    }

    public static NearByCustomersActivity_.IntentBuilder_ intent(android.support.v4.app.Fragment supportFragment) {
        return new NearByCustomersActivity_.IntentBuilder_(supportFragment);
    }
    ...
    public void onViewChanged(HasViews hasViews) {
        ...
        if (layout_back!= null) {
            layout_back.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View view) {
                    NearByCustomersActivity_.this.back();
                }
        ...
        if (iv_submit!= null) {
            iv_submit.setOnClickListener(new OnClickListener() {
                ...
                @Override
                public void onClick(View view) {
                    NearByCustomersActivity_.this.previewOnMap();
                }
    ...
    public static class IntentBuilder_
        extends ActivityIntentBuilder<NearByCustomersActivity_.IntentBuilder_>
    {
        ...
        public IntentBuilder_(Context context) {
            super(context, NearByCustomersActivity_.class);
        }

        public IntentBuilder_(android.app.Fragment fragment) {
            super(fragment.getActivity(), NearByCustomersActivity_.class);
            fragment_ = fragment;
        }
        ...
        public NearByCustomersActivity_.IntentBuilder_ type(int type) {
