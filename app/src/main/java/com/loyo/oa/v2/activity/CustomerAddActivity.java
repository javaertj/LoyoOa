...
public class CustomerAddActivity extends BaseActivity implements View.OnClickListener {
    ...
    @Click({R.id.img_title_left, R.id.img_title_right,
            R.id.layout_customer_label, R.id.btn_add_new_contract})
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.img_title_right:
                ...
                try {
                    ...
                    if (items != null && items.size() > 0) {
                        ...
                        jsonObject.put("tagitems", jsonArrayTagItems);
                    }
            ...
            case R.id.layout_customer_label:
                ...
                if (items != null) {
                    bundle2.putSerializable("tagitems", items);
                }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case REQUEST_CUSTOMER_LABEL:
                ...
                items = (ArrayList<TagItem>) bundle.getSerializable("data");
                ...
                for (TagItem item : items) {
                    if (sb == null) {
                        sb = new StringBuffer();
                        sb.append(String.valueOf(item.getName()));
